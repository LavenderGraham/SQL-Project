...
The country with the highest revenue is by far the United States. Cities not available in the demo dataset form a pluarilty of the sales. However the top identified cities for sales revenue include:
1. San Francisco
2. Sunnyvale
3. Atlanta
4. Palo Alto
...
As you can see the top four cities are American.
...
v2ProductName							total_quantity_sold
Leatherette Journal						65
Waze Dress Socks						10
Red Spiral Google Notebook					8
Reusable Shopping Bag						4
Google Sunglasses						2
...
Nest® Learning Thermostat 3rd Gen-USA - Stainless Steel		1
...
YouTube Leatherette Notebook Combo				1
